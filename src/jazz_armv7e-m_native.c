...
extern void __jazz_polyvec_compress10(uint8_t *des, int16_t *src);
...
extern void __jazz_stack_polyvec_compress10(uint8_t *des, int16_t *src);

int main(void){

    int16_t a[KYBER_K * KYBER_N];
...
// Polynomial compression
    ...
    __jazz_polyvec_compress10(res, a);
    assert(memcmp(ref, res, KYBER_K * 320) == 0);

    __jazz_stack_polyvec_compress10(res, a);
    assert(memcmp(ref, res, KYBER_K * 320) == 0);
